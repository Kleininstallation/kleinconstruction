      ...
      <div className="columns-container-service">
          <div className="servicepagesection">
            <div className="image-sizer">
              <Image src="/images/hvac-1.jpg" width="1000" height="1000" alt="Picture of a house" />
            </div>
          ...
          <div className="servicepagesection">
            ...
            <div className="image-sizer">
              <Image src="/images/hvac-2.jpg" width="1000" height="1000" alt="Picture of the cabinets" />
            </div>
          </div>
        </div>
